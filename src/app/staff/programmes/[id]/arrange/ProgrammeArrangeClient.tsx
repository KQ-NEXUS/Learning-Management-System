...
export function ProgrammeArrangeClient({
  ...
  return (
    <div className="flex flex-col gap-6">
      <p className="max-w-prose text-sm text-foreground border-b border-border py-3">
        ...
        <>
          <ArrangeBoard
            ...
            renderItemAction={(item) => (
              <button
                type="button"
                className="rounded-md border border-danger/40 bg-surface px-2 py-1 text-xs font-semibold text-danger hover:bg-danger-surface disabled:opacity-40"
      ...
      <section className="flex flex-col gap-2 border-t border-foreground pt-5">
